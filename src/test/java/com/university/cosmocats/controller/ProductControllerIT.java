...
import com.university.cosmocats.AbstractIt;
...
class ProductControllerIT extends AbstractIt {
    ...
    private static final String PRODUCT_NAME = "Banana2";
    ...
    void createProduct_validRequest_shouldReturnCreatedProduct() {
        ...
        given()
                ...
                .body(PRODUCT_ID_FIELD, notNullValue())
    ...
    void getProductById_validId_shouldReturnProduct() {
        given()
                ...
                .body(PRODUCT_NAME_FIELD, notNullValue())
                .body(PRODUCT_DESCRIPTION_FIELD, notNullValue())
                .body(PRODUCT_PRICE_FIELD, notNullValue());
    }

    @Test
    @DisplayName("Should return 404 while getting product by invalid id")
    void getProductById_invalidId_shouldReturnNotFound() {
        given()
                .port(port)
                .contentType(ContentType.JSON)
                .when()
                ...
                .body(ProblemDetailFieldNames.PROBLEM_DETAIL_FIELD, equalTo("Product with id: 100 was not found"))
    ...
    @Test
    @DisplayName("Should return 404 while updating product by invalid id")
    ...
    @Test
    @DisplayName("Should delete product by valid id and return 204 NO CONTENT")
    void deleteProduct_validId_shouldDeleteAndReturnNoContent() {
        given()
                .port(port)
                .contentType(ContentType.JSON)
                .when()
    ...
    void deleteProduct_invalidId_shouldReturnNoContent() {
        given()
                .port(port)
                .contentType(ContentType.JSON)
                .when()
